...
;
;  Copyright (c) 1992-1998 by John Hartman
;
...
RAM_START           equ       $4000               ; START OF MONITOR RAM
...
B1                  fcc       '68HC11 monitor V1.3'  ; DESCRIPTION, ZERO
                    fcb       0
