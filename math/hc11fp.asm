...
ASCFLT              pshx                          ; SAVE POINTER TO ASCII STRING.
...
FINISH              stx       6,y                 ; SAVE POINTER TO TERMINATING CHARACTER IN STRING.
...
NUMERIC             cmpa      #'0'                ; IS IT LESS THAN AN ASCII 0?
...
FPNORM              ldx       #FPACC1EX           ; POINT TO FPACC1.
...
FPMULT3             clc                           ; SHOW ; NO ERRORS. Moved the FPMULT3 label to this instruction from the TST instruction above. G.S.D. 12/20/91
...
FLTCMP              tst       MANTSGN1            ; IS FPACC1 NEGATIVE?
...
UINT2FLT            ldx       #FPACC1EX           ; POINT TO FPACC1.
...
SINT2FLT            clr       MANTSGN1            ; initialize the FPACC1 mantissa sign to zero (positive) Added 12/17/91 G.S.D.
...
FLT2INT             ldx       #FPACC1EX           ; POINT TO FPACC1.
                    jsr       CHCK0               ; IS IT 0?
...
FLTSQR              ldx       #FPACC1EX           ; POINT TO FPACC1.
                    jsr       CHCK0               ; IS IT ZERO?
...
FLTSIN              jsr       PSHFPAC2            ; SAVE FPACC2 ON THE STACK.
...
FLTCOS              jsr       PSHFPAC2            ; SAVE FPACC2 ON THE STACK.
                    jsr       ANGRED              ; GO REDUCE THE ANGLE TO BETWEEN +/-PI.
                    pshd                          ; SAVE THE QUAD COUNT.
                                                  ; SAVE THE SINE/COSINE FLAG.
...
SINCOS              psha                          ; SAVE SINE/COSINE FLAG ON STACK.
...
ANGRED              clra                          ; INITIALIZE THE 45'S COMPLEMENT FLAG.
...
FLTTAN              bsr       PSHFPAC2            ; SAVE FPACC2 ON THE STACK.
...
DEG2RAD             bsr       PSHFPAC2            ; SAVE FPACC2.
...
PSHFPAC2            pulx                          ; GET THE RETURN ADDRESS OFF OF THE STACK.
...
PULFPAC2            tsx                           ; POINT TO THE RETURN ADDRESS.
...
GETFPAC2            ldd       ,x                  ; GET THE EXPONENT & HIGH BYTE OF THE MANTISSA,
...
PUTFPAC2            ldd       FPACC2EX            ; GET FPACC1 EXPONENT & UPPER 8 BITS OF MANT.
